...
public sealed class MenuClienteService(ApiClient api, AppState estado)
{
    ...
    private static readonly Dictionary<string, string> RutasPorCodigo = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["ERP.RH"] = "/erp/rh",
        ["ERP.RECURSOS_HUMANOS.EMPLEADOS"] = "/seguridad/empleados",
        ["ERP.RECURSOS_HUMANOS.CATALOGO_DE_EMPLEADOS"] = "/seguridad/empleados",
        ["ERP.RECURSOS_HUMANOS.EMPLEADOS.CATALOGO_DE_EMPLEADOS"] = "/seguridad/empleados",
        ["ERP.RH.EMPLEADOS"] = "/seguridad/empleados",
        ["ERP.PROVEEDORES"] = "/erp/proveedores",
        ["ERP.PROVEEDORES.CATALOGO_DE_PROVEEDORES"] = "/erp/proveedores/catalogo-de-proveedores",
        ["ERP.PROVEEDORES.PRODUCTOS_POR_PROVEEDOR"] = "/erp/proveedores/productos-por-proveedor",
        ["ERP.PROVEEDORES.CONDICIONES_DE_COMPRA"] = "/en-construccion/condiciones-de-compra",
        ...
        ["ERP.ALMACENES.SUCURSALES"] = "/almacen/almacenes",
        ...
        ["ALMACEN.SUCURSALES"] = "/almacen/almacenes",
        ...
        ["CORE.ZONAS.ZONAS_COMERCIALES"] = "/core/zonas/zonas-comerciales",
        ["CORE.ZONAS.ZONAS_DE_REPARTO"] = "/en-construccion/zonas-de-reparto",
